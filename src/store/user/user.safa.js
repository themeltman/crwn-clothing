...
import {
    ...
    signInUserWithEmailAndPassword, createAuthUserWithEmailAndPassword, sigOutUser
...
export function* signUp({payload: {email, password, displayName}}) {
    try {
        ...
        yield put(signUpFailed(`Can not create account: ${error.message}`))
...
export function* onCheckUserSession() {
    yield takeLatest(USER_ACTON_TYPES.CHECK_USER_SESSION, isUserAuthenicated)
}
